    ...
    <header>
        <nav class="nav-container">
            <div class="nav-link-container">
                ...
                <ul>
                    <li><a href="index.html" title="Accueil" class="nav-link">Accueil</a></li>
    ...
    <main>
        <div class="pub-contain">
            <div class="contact-contain">
                <p class="news-road"><a href="index.html" class="delete-decoration">Accueil</a> > <a href=""
                        class="delete-decoration">Catégories</a> > title</p>
                <h2 class="asside-title-link">title</h2>
                <div class="asside-decoration"></div>
                <img src="img/branden-skeli-NIO1ZDB5kL0-unsplash.jpg" alt="image-news-title" class="news-img">
                <p class="white news-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis
                    ratione iste impedit fugiat
                    ...
                    culpa officia! <br> <br> Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus
                    voluptatem
                    saepe, asperiores
                    ...
                    <div class="suggest-container">
                        <div class="suggest">
                            <a href="news-title.html">
                                <img src="img/branden-skeli-NIO1ZDB5kL0-unsplash.jpg" alt="">
                            </a>
                            <h3 class="delete-space"><a href="" class="white suggest-link">titre</a></h3>
