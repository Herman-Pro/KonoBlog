  ...
  <div class="pub-contain">
    <div class="news-contain">
      <div class="item">
        ...
        <h2 class="delete-space"><a href="{{ route('news.title') }}" class="white delete-space news-title">titre</a></h2>
        <p class="white delete-space news-description">description Lorem ipsum dolor sit amet consectetur adipisicing
          ...
          adipisci similique dicta? Fugit, vitae et? <a href="{{ route('news.title') }}" title="Lire_la_suite">Lire la suite...</a></p>
        <p class="news-time"><i class="fi fi-rs-clock-three"></i> date de publication</p>
      </div>
      <!-- Répétez les autres éléments de news ici -->
    </div>
      ...
      <section>
        ...
        <div class="best-news-contain">
          ...
          <div class="best-news-info">
            <h3 class="delete-space"><a href="{{ route('news.title') }}" class="delete-space best-news-title">Titre</a></h3>
            <p class="delete-space best-news-time"><i class="fi fi-rs-clock-three"></i> date de publication</p>
          </div>
        </div>
        <!-- Répétez les autres éléments de best-news ici -->
      </section>
      <section>
